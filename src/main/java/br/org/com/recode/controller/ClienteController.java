...
import br.org.com.recode.controller.form.CliForm;
...
public class ClienteController {
	...
	@GetMapping("/listar")
	  ...
	  public ResponseEntity<ClienteDTO> cadastrar(@RequestBody @Valid CliForm form, UriComponentsBuilder uriBuilder) {
